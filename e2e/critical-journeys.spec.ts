...
async function mockBoundaries(page: Page) {
  await page.route("**/*", async (route) => {
    ...
    if (path === "/profile/me/") return route.fulfill({ json: { id: "10000000-0000-0000-0000-000000000001", display_name: "Current Reader", avatar_url: null, contacts: {}, community_id: "20000000-0000-0000-0000-000000000001", community_name: "North Readers", community_location: "North", community_public: true, admin: false, is_app_admin: false, pending_community_name: null, pending_community_request_id: null, created_at: "2025-01-01T00:00:00Z" } })
