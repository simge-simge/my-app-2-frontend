...
const styles = StyleSheet.create({
  googleButton: { minHeight: 50, borderRadius: radii.md, borderCurve: "continuous", borderWidth: 1, borderColor: palette.border, backgroundColor: palette.paper, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 11, paddingHorizontal: 18 },
  ...
  googleText: { color: palette.ink, fontSize: 15, fontWeight: "700" },
