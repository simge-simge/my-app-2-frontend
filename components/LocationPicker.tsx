...
const styles = StyleSheet.create({
  ...
  inputRow: { minHeight: 52, flexDirection: "row", alignItems: "center", gap: 9, borderWidth: 1, borderColor: palette.border, borderRadius: radii.md, paddingHorizontal: 14, backgroundColor: palette.paper },
  ...
  results: { marginTop: 6, borderWidth: 1, borderColor: palette.border, borderRadius: radii.md, overflow: "hidden", backgroundColor: palette.surface },
