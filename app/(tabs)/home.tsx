...
const styles = StyleSheet.create({
  ...
  container: { flexGrow: 1, width: "100%", maxWidth: layout.contentMax, alignSelf: "center", paddingHorizontal: 20, paddingTop: 18, paddingBottom: 112, gap: 24 },
  ...
  name: { fontFamily: typography.serif, fontSize: 24, lineHeight: 30, fontWeight: "700", letterSpacing: -0.4, color: palette.ink },
  ...
  iconButton: { width: 44, height: 44, borderRadius: radii.md, alignItems: "center", justifyContent: "center", backgroundColor: palette.paper, borderWidth: 1, borderColor: palette.border },
  ...
  hero: { position: "relative", overflow: "hidden", backgroundColor: palette.paper, borderWidth: 1, borderColor: palette.border, borderRadius: radii.lg, borderCurve: "continuous", padding: 22, ...shadows.soft },
  heroWide: { flex: 0.84, justifyContent: "center", padding: 30, minHeight: 560 },
  heroDecor: { position: "absolute", inset: 0 },
  heroDot: { position: "absolute", width: 90, height: 90, borderRadius: 45, right: -30, top: -28, backgroundColor: palette.accentSoft, opacity: 0.8 },
  heroDash: { position: "absolute", width: 82, height: 4, borderRadius: 4, right: 22, bottom: 20, backgroundColor: palette.accent, opacity: 0.35 },
  ...
  heroTitle: { maxWidth: 540, fontFamily: typography.serif, fontSize: 32, lineHeight: 38, fontWeight: "700", letterSpacing: -0.7, color: palette.ink },
  ...
  primaryAction: { minHeight: 50, marginTop: 16, paddingHorizontal: 19, borderRadius: radii.md, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, backgroundColor: palette.accent },
  primaryActionText: { color: palette.white, fontSize: 15, fontWeight: "700" },
  ...
  sectionEyebrow: { color: palette.accentDark, fontSize: 10, fontWeight: "800", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 3 },
